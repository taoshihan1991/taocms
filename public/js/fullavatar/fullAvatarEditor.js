function fullAvatarEditor() {
	...
	var file			= siteConfig.siteurl+'public/js/fullavatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= siteConfig.siteurl+'public/js/fullavatar/expressInstall.swf';		//expressInstall.swf的路径
