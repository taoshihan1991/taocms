...
//swfupload 模拟ajax访问此控制器
class c_swfupload extends SAjax{
	...
	public function index(){
		...
		if(!$this->CheckAccess('products')){
			$this->header_err(530); //验证添加产品的权限
		}
		...
		$lastName = 'image_'.$this->user->data['userid']. '_' . md5(uniqid($fileName)) . '.' . $fileExt;
